...
# Research Plan for BaM2, My Documents, September 2020

## Goals
1. **What product & team are you doing this research for?**

This research is for the transition of the My Documents tool from eBenefits to VA.gov led by the Benefits & Memorials 2 team.  

2. **Background: Briefly, what is the background on this product? What would a new person on the team need to know about this product?**

eBenefits is being sunsetted, so the My Documents tool needs to be migrated over to VA.gov. The My Documents tool contains documents that have been digitally uploaded by the Veteran, their representative(s), or potentially VA. Documents that were mailed in, faxed, or physically submitted do not appear in the tool. Additionally, some documents may be restricted from user access. Our team wants to uncover reasons why Veterans may use this tool, where they expect it to live on VA.gov, and what pain points they experience using the tool on eBenefits.
...
- For example, Veterans will expect to find documents for their benefits claims within the Claims Status tool
...
1.	**What method of research are you planning?**
  ...
  - Remote moderated qualitative user interviews and usability test tasks using the existing My Documents tool on eBenefits
  
2.	**Why this method? How does this methodology help you answer your research questions?** 

- We’re using moderated qualitative interviews to discover successes and pain points Veterans experience trying to find their VA-related documents; we’re including task-based usability using the existing tool to uncover ways we can improve the experience as the tool is migrated over to VA.gov.  
...
- The My Documents tool in eBenefits
...
- Participants will need to log into eBenefits as part of the study. Please include the following screener questions:
   - “Have you used eBenefits to look for VA documents you’ve submitted in the past?” 
      - Yes (Qualifies)
      - No
   - “Are you comfortable signing into your eBenefits account as part of the session?” 
      - Yes (Qualifies)
      - No 
...
_This criteria contains nice-to-haves that creates a diverse participant pool._
...
- At least one person who uses assistive technology (AT) such as specialized keyboards and switches
...
We are looking to start sessions **September 10th, 2020**.

2.	**Prepare: When will the thing you are testing be ready?**

N/A - tool being tested is already in production
...
- September 10th: 9:30am - 5:00pm EST

- September 11th: 9:30am - 5:00pm EST

- September 14th: 9:30am - 5:00pm EST

- September 15th: 9:30am - 5:00pm EST

- September 16th: 9:30am - 5:00pm EST
...
- **Project point of contact**: Riley Orr, Rebecca Walsh, or Leah Keeler (lkeeler@governmentcio.com) 
- **Participant(s) for pilot test**: Riley Orr, Rebecca Walsh, Leah Keeler, Brad Conley
- **Note-takers**: Riley Orr & Rebecca Walsh
- **Observers**: Leah Keeler, Matthew Self, Brad Conley, Cameron Testerman, and Craig Wheeler 

**List email addresses for those who should attend and observe the sessions: VA Stakeholders, engineering team members, design team members, any other people who might find this research relevant to their work**

- Riley Orr (riley@amida.com)
- Rebecca Walsh (rebecca.walsh@adhocteam.us)
- Leah Keeler (lkeeler@governmentcio.com)
- Matthew Self (matthew.self2@va.gov)
- Brad Conley (bconley@governmentcio.com)
- Cameron Testerman (cameron@oddball.io)
- Craig Wheeler (cwheeler@governmentcio.com) 

## Resources
- [Project Brief](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/eFolders_Migration/Product_Outline.md) 
