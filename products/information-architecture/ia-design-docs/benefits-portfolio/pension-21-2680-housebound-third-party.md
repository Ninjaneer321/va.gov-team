...
**CAIA Intake ticket:** [#127560](https://github.com/department-of-veterans-affairs/va.gov-team/issues/127560)

**IA Tracker:** [#132907](https://github.com/department-of-veterans-affairs/va.gov-team/issues/132907)
...
- Breadcrumb: VA.gov home > VA forms > Application for Aid and Attendance benefits or Housebound allowance form > Apply for Aid and Attendance or Housebound allowance online
...
- All pages within form flows will exist as child pages of the core/canonical URL.
  - Examples:
      - va.gov/[insert form URL]/introduction/
      - va.gov/[insert form URL]/review-and-submit/
      - va.gov/[insert form URL]/confirmation/
...
| ------------- | ------------- | ------------- | ------------- |
| Communicate if staged/incremental launch is planned | [team] | ASAP | initiates coordination of widget creation |
| Submit redirect request (if applicable) | [team] | at least two weeks prior to implementation |  |
| Communicate date of staging review | [team] | Once scheduled | Allows OCTO to prepare entry point preview links |
| Communicate launch date | [team] | Once scheduled | Allows OCTO to plan for updates to About and static pages |


### Staged rollout
*Is the team planning a staged rollout? Roll-outs hidden behind a flipper flag need a static page to place a sign in widget or CTA on. Pages/sections where a sign in widget can't be implemented - within accordions, hub pages*
