# Release Plan - Representative Claims Submission Form Upload
...
Feature toggle:
[Flipper for the API endpoint](url)
...
- Desired date range or test duration: Jun 16 - Jul 16, 2025
- Desired number of users: 20
- How you'll recruit the right production test users: Existing and prospective pilot participants
- How you'll conduct the testing: Representatives will upload 686c PDF upload with supporting evidence and submit
- How you'll give the test users access to the product in production w/o making it live on VA.gov: Our pilot participants do have existing access to the portal prior to this feature. Only those who have access to this feature will be able to use it.
