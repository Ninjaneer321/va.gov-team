---
title: "QuickSubmit Review for ARP Research Findings"
product: "Accredited Representative Portal (ARP)"
team: "Accredited Representative Facing"
...
key_findings:
  ...
  - "Representatives felt very positive about QuickSubmit's ease and success rate"
  - "After POA is established, and representatives enter information about the claimant into their CRMs, representatives use QuickSubmit"
  - "Upload multiple files at one time is very high importance to representatives"
  - "Indicate priority of submission to expedite processing is high importance to representatives"
  - "Receive confirmation of submission by email is high importance to representatives"
  - "Preview the document is high importance to representatives"
  - "View claim upload status is high importance to representatives"
  - "Benefit types need better definition and clarity"
  - "Expedited Submission should be apparent, when marking an emergent indicator"
  - "Error handling post submission needs improvement"
recommendations:
  - "Implement very high and high importance features"
  - "Design to include the functionality available in the backend"
  - "Test early with VSO representatives to ensure ease of use and satisfaction"
...
opportunity_areas:
  - "Improve clarity and definition of benefit claim types"
  - "Make expedited submission indicators more apparent and consistent"
  - "Provide means to resolve errors pre or post file submission"
further_research_needed:
  - "How cross-accredited representatives switch organizations based on claimant's need or claim type"
  - "How representatives with larger caseloads use QuickSubmit differently"
underserved_groups_missing:
  - "VSO representatives with larger caseloads"
  - "Cross-accredited representatives who frequently switch organizations"
secondary_research: []
