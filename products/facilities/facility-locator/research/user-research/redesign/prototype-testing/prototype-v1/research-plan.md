...
Our objective for this research is to test a first iteration of the redesign. We want to learn how Veterans and Caregivers may use the new filter feature as well as the addition of the quick links.

#### Research questions:
- Is it more intuitive to have two search fields instead of three?
- How are people filtering services for each facility type?
- Is there a need for a Google-like open search?

#### Hypothesis: 
Our hypothesis is that 

## Method
Remote Moderated Usability Testing will help us gain feedback on the first iteration of the redesign prototype. We will watch for pain points in the user flow and areas to improve the next iteration of the prototype.
