---
title: "Veteran Facing VBA research Topline Summary"
product: "Facilities"
team: "Facilities"
...
demographics:
  ...
  disability:
    ...
    captions: 0
key_findings:
  - "Veterans want to speak with a human when they are discovering what's possible"
  - "Veterans want to complete tasks online when tasks are clear"
  - "Problems encountered were never really connected to VBA website content issues"
  - "Veterans encountered problems with authenticated experience"
  - "Veterans found the information they wanted on the VBA website or Google Maps"
  - "Veterans expect Benefit Centers to be 'one stop shops' for services"
  - "Veterans demonstrated a sophisticated use of ad hoc social media communities to inform their relationship with the VA"
recommendations: []
kpi_alignment: []
outcomes:
  user: "Not specified"
