...
research_goals:
  - "Make the login experience more accessible for low vision and no vision users"
  - "Find any issues or pain points when using screen readers and other assistive technology"
  - "Discover how users navigate the login portion of the new login page"
  - "Discover any inconsistencies regarding the current design of the login page (pain points for users)"
  - "Test the efficiency of the current login page and find measurements"
methodology:
...
key_findings:
  ...
  - |
    Sign-in took approximately five to ten minutes to complete due to factors such as:
     ...
     - Using multiple assistive technology in tandem with their phones
...
recommendations:
  ...
  - "Increase the time needed for Multi-Factor-Authentication. Limited vision and screen reader users take extra time to use their devices to get a code. This is most prominent if the user does not use a password manager."
