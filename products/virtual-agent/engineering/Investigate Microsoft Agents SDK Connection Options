...
In the effort of saving time to meet our prod release in the June timeframe, it would be in our best interest to stick with Directline as opposed to wiring an alternative connection layer using something like Socket.IO. 
