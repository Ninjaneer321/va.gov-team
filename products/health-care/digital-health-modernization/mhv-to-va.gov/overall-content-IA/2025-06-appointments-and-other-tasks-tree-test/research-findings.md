...
To download their Individual Longitudinal Exposure Record (ILER) in support of a benefit claim, many Veterans selected paths under Health, Claims and Appeals, Benefit Applications and Forms, or other Disability-related areas. Only 20.8 percent navigated to the correct path, Records under VA Benefits and Health Care. While this tree-test did not have a statistically significant number of participants, the low findability of this form may point to an opportunity to add a cross-link to the ILER from within the My VA page. 
