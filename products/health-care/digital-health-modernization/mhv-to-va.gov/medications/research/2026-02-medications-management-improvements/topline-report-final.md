...
- [Key insights](#key-insights)
  - [Insight 1: Navigation between medication pages was not always clear](#insight-1-navigation-between-medication-pages-was-not-always-clear)
  - [Insight 2: The filter "Update list" button was frequently overlooked](#insight-2-the-filter-update-list-button-was-frequently-overlooked)
- [Additional findings](#additional-findings)
  - [Finding 3: The "Too early to refill" card content could benefit from clearer timing information](#finding-3-the-too-early-to-refill-card-content-could-benefit-from-clearer-timing-information)
  - [Finding 4: Some participants had difficulty locating the print feature](#finding-4-some-participants-had-difficulty-locating-the-print-feature)
  - [Finding 5: The grey "Too early to refill" card's visual treatment may cause it to be overlooked](#finding-5-the-grey-too-early-to-refill-cards-visual-treatment-may-cause-it-to-be-overlooked)
  - [Finding 6: The term "in-progress medications" was not immediately clear to some participants before opening the page](#finding-6-the-term-in-progress-medications-was-not-immediately-clear-to-some-participants-before-opening-the-page)
...
9 Veterans participated in moderated usability sessions evaluating new medication management pages (Medications Page, Medication History Page, In-Progress Medications Page). Overall, participants responded positively to the conceptual design, describing it as "intuitive" and "easy" (8 of 8 who completed the full session; P7 excluded due to a screen freeze during Task 3). However, two usability issues emerged that may affect task completion in production:

1. **The filter "Update list" button was frequently overlooked.** 7 of 8 participants selected filters but did not click "Update list" at least once during the session. Because the button was missed, the filter did not apply, and participants often assumed they were viewing a filtered list.  
   *(P7 excluded due to technical issues.)*

2. **Veterans often started on the refill page when looking for medication status.** Initial navigation typically began from the "Refill VA medications" link on the MHV landing page. 7 of 9 participants started there when trying to check the status of a medication. Because this page only shows refillable medications, participants sometimes needed to navigate to another page to find status information.

**Central tension:** The new design separates medications across three distinct pages, but users do not arrive with a mental model of this three-page structure. They expect "Medications" or "Refill VA medications" to show everything. When participants had difficulty locating the information they were looking for, some mentioned they might use another channel for help. 3 of 9 participants (P7, P12, P15) said they might call the pharmacy or send a secure message rather than continue navigating.
...
**Yes, with some caveats around navigation.**
...
- The challenge is not comprehension, it's getting to the right page. Users who reached the correct page could complete tasks. Users who could not find the right page sometimes said they might call the pharmacy (P7, P12, P15).
...
- 7 of 9 participants landed on the refill-only Medications Page as their first destination in Task 1. 5 clicked "Refill VA medications" from the MHV landing page (P1, P5, P7, P12, P15) and 2 used the Medications tab in the secondary nav (P4, P13). Only P8 and P16 started with "Review medications." When their medication was not there, recovery depended on noticing cross-links — which 3 participants missed.
...
- The In-Progress page provided status information users valued. 7 of 8 participants who viewed the page correctly interpreted the information shown (P7 excluded due to screen freeze; P5 did not visit the page during Task 1). All 8 participants who saw the page (including P7 after the moderator navigated there) responded positively. P7: "When I've called, sometimes I'm not sure, did I place this order? So that's good, so I can check it on my own." P12: "This lets me know everything I need to know at the present time." P15: "Gives me everything I need to know about in-progress medications."
- When status was not easy to find, some participants mentioned they might use other channels. P12 immediately said she'd message the pharmacy; P15 said he'd call; P4 said she'd message her doctor.

### RQ3: How do users move between the different interfaces?

**Cross-links are the primary way users move between medication pages, but they were not always noticed.**
...
- Cross-links ("Go to your in-progress medications," "Review and print list of medications") were missed by 3 participants in Task 1, requiring backtracking or alternative paths. P7 and P12 did not notice the "Go to your in-progress medications" link on the Medications Page; P8 noticed it but was unsure what it meant. P12 also missed the "Review and print list of medications" link entirely.
...
- When users missed cross-links, they either went back to the MHV landing page (P5, P7, P12 in Task 1), used secondary nav or breadcrumbs (P4, P7, P13, P16), or said they might call/message the pharmacy (P7, P12, P15).
- The term "in-progress medications" was not immediately clear before users experienced the page. P8: "Go to your in-progress medications. Now I'm confused, because I'm not sure what that one means." P7: "I don't know what that is... I'm guessing that means you've placed the order."

---

## Key insights

### Insight 1: Navigation between medication pages was not always clear

**Signal:** Many participants expected a single medications page and did not initially recognize that medication tasks were distributed across multiple pages.

**The core problem:** The new design distributes medications across three pages, but users do not always understand this structure when they arrive. They expect "Medications" or "Refill VA medications" to show them everything.

#### Part A: Users start on the wrong page for their task

7 of 9 participants landed on the refill-only Medications Page as their first destination in Task 1. 5 used "Refill VA medications" from the MHV landing page (P1, P5, P7, P12, P15) and 2 used the Medications tab in the secondary nav (P4, P13). Only P8 and P16 started with "Review medications" and landed on the Medication History page.

**Evidence:**
- In Task 1 (find refill status of Lipitor), 7 of 9 participants started by navigating to the Medications Page (refill-only). Lipitor was not on this page because it had already been submitted and was in progress. Users had to find a path to the In-Progress Medications page or Medication History page to locate it.
...
**Why this matters:** Users arrive expecting a single medications list. When they do not see what they are looking for, they may assume the medication is not in the system rather than recognizing they need to navigate to a different page. 2 of 9 participants (P1, P7) explicitly interpreted the refill page as a full medication list.

#### Part B: Cross-links are the primary recovery mechanism, but they are frequently missed

The text-based links that connect the three pages were frequently overlooked or not understood. These links are doing critical work in the design — they are how users are supposed to move between pages when they start on the wrong one.
...
**3 of 9 participants did not successfully use the "Go to your in-progress medications" link in Task 1.** 2 did not notice the link without moderator prompting (P7, P12). 1 noticed the link but hesitated due to unclear labeling (P8).
...
#### Part C: When cross-links are missed, users take inefficient paths or use other channels

When users did not notice the cross-links, they employed these recovery strategies:

1. **Returning to the MHV landing page.** 3 of 9 participants (P5, P7, P12) went back to the landing page in Task 1 to try a different path after realizing the page they were on did not contain what they were looking for.
...
3. **Using another channel.** 3 of 9 participants (P7, P12, P15) said they might call the pharmacy or send a secure message when they could not find information. P4 also said she would message her doctor about an old medication rather than use the filters to find it.
...
**Why it works:** The success alert appears at the moment a user is most motivated to check status — right after taking an action. It is contextual, timely, and visually prominent.
...
**Implication:** The success alert pattern (contextual, appears at moment of motivation, visually distinct) may be a useful model for other navigation pathways in the experience.

#### Navigation and wayfinding recommendations
...
### Insight 2: The filter "Update list" button was frequently overlooked

**Signal:** Many participants expected the list to update automatically after selecting a filter and did not notice the "Update list" button.

7 of 8 participants missed the "Update list" button at least once when selecting a filter. In these cases, participants often assumed the filter had been applied when it had not. *(P7 excluded from all filter counts — moderator controlled the screen due to technical issues.)*
...
| P12 | Task 2 | Selected "Inactive medications" but did not click "Update list"; then selected different filter and did click it |
...
**Observed across multiple tasks:** P4 missed the button across multiple tasks (Tasks 3 and 4), suggesting the interaction may be easy to overlook. P16 also missed it across Tasks 2 and 4.

**Downstream risks:**
- **Task 2 (find old medication):** 4 of 8 participants (P5, P8, P12, P15) who attempted to use the filter did not apply it correctly, leading some to believe the rash cream was not in the system because they thought they had filtered to Inactive medications when they had not. *(P7 excluded — moderator controlled the screen.)*
- **Task 4 (print medications list):** 2 of 8 participants (P4, P16) selected filters but did not apply them, meaning the list they intended to print did not reflect their selection. This could result in a user bringing an inaccurate medication list to a doctor's appointment. *(P7 excluded — moderator controlled the screen.)*

**Recommendation:** Consider auto-applying filters on radio button selection (this matches user expectation). If a manual apply button must remain, make it visually unmissable — for example, a prominent button that changes state when a new radio button is selected.

---

## Additional findings

### Finding 3: The "Too early to refill" card content could benefit from clearer timing information

**Signal:** Participants understood the message, but some wanted clearer information about when the medication would become eligible for refill or shipment.
...
**Recommendation:** Consider adding an estimated eligibility date or refill window to the grey card to provide additional clarity and reduce uncertainty.

### Finding 4: Some participants had difficulty locating the print feature

**Signal:** The print feature was difficult for some participants to locate because it appears below a potentially long list of medications.

**Discoverability:** The print feature is located at the bottom of the Medication History Page, below the medication list. 4 of 8 participants who attempted Task 4 had difficulty locating it (P7 excluded due to screen freeze). Because the feature appears below a potentially long list of medications, participants often needed to scroll through the list before discovering it.

- P12 missed the feature entirely and said she would right-click to print instead. After the moderator directed her to it, she stated the print feature "did not pop out to her."
...
Of the 8 participants who attempted the task, 4 (P1, P8, P13, P16) located the print feature relatively quickly, while 4 (P4, P5, P12, P15) had noticeable difficulty finding it.
...
**Interaction consideration:** When combined with the filter interaction described in Insight 2, there is a possibility that the printed list may not reflect the filter a participant intended to apply. In Task 4, 2 of 8 participants (P4, P16) selected filters but did not click "Update list," meaning the list remained unchanged before printing. *(P7 excluded due to moderator-controlled screen.)*

**Recommendation:** Consider increasing the visibility of the print feature or clarifying the labeling within the print menu to improve discoverability and reduce uncertainty around the printing action.

### Finding 5: The grey "Too early to refill" card's visual treatment may cause it to be overlooked

**Signal:** The muted styling of the grey card may make it less visually prominent than other status sections on the page.

The grey card's muted styling may make it less noticeable on the In-Progress Medications Page. While all 9 participants who encountered the card correctly interpreted its meaning, 3 of 9 participants (P1, P12, P13) initially had difficulty locating it on the page, either scrolling past it or not noticing it at first.

- P1 scrolled past the grey Lipitor card during his first scan of the page: "Oh, wait, yeah, Lipitor is there. Oh my god, I missed it. Wow, maybe I need to put on my extra goggles."
- P1 also commented while scanning the page: "Request submitted. Okay, so these are probably the medications that I've already submitted for. These are the ones that are in progress, and these are the ones that are heading to me, so that's helpful, but I still don't see my Lipitor." This suggests the grey card's visual separation from the colored status groupings may have contributed to it being overlooked.
- P13 initially scrolled while searching for Lipitor and had difficulty locating it (partly influenced by prototype scrolling behavior) before eventually finding it.
- P12 did not notice the grey card and required moderator guidance to locate it. The muted visual treatment appeared easier to overlook compared to the colored status sections.

**Recommendation:** Consider whether the visual prominence of the grey cards is sufficient relative to other elements on the In-Progress Medications Page. Slight adjustments to contrast or emphasis may help ensure the card is noticed while maintaining its distinction from the active status states.

### Finding 6: The term "in-progress medications" was not immediately clear to some participants before opening the page

**Signal:** Some participants were unsure what "in-progress medications" meant until they opened the page.

Users generally understood the In-Progress Medications page once they arrived, but the label itself did not always clearly communicate what information the page contained. 2 of 9 participants (P7, P8) explicitly expressed uncertainty about the meaning of the term before selecting the link.
...
These responses suggest that the concept of tracking refill status was well understood once the page was visible, but the link label alone did not always communicate that purpose beforehand.

**Recommendation:** Consider more descriptive link text (for example, "Track your refill requests" or "See refill status") to clarify what users will find on the page before selecting the link.
...
**Expectation of a single medications list:** 2 of 9 participants (P1, P7) explicitly interpreted the Medications Page as a full medication list rather than a list of refillable medications only.
- P1: "Because I anticipate that if I click on it, it will give me all of my medications."
- P7: "That's what I don't like. When there's no refills left, it takes it out of your list."

**Alternative channels when stuck:** When participants encountered friction, some mentioned they would use another channel for help. 4 of 9 participants (P4, P7, P12, P15) expressed they might use non-digital or messaging channels if they could not find what they needed.
...
**Learnability appears high:** P8 noted he understood it would not make sense to find Lipitor on the refills page but "didn't realize at first. Learned from using the app." P4 stated "I think once you understand how it works, it's very easy to use." P12 described the session as a "learning experience" and noted she'd never looked for some of the features before despite 10 years of use.
...
|---|---|---|
| Most Veterans will find and understand in-progress medication status | Partially | Understood once there (7 of 8 who viewed it); getting there was inconsistent (7 of 9 landed on refill-only page first in Task 1) |
...
| Veterans will use navigation cues, links, filtering, and sorting | Partially | Used when noticed; cross-links missed by 3 participants in Task 1; "Update list" missed by 7 of 8 at least once (P7 excluded) |
| Most Veterans will locate medications when they don't know the name | Partially | Task 2 required moderator intervention for some; 4 of 8 did not apply filter correctly (P5, P8, P12, P15; P7 excluded) |
...
| Most Veterans will find a complete list of current medications | Partially | Filter issues (4 of 8 in Task 2; 2 of 8 in Task 4 did not apply filter; P7 excluded) and Active vs. All ambiguity (5 of 8 Active vs. 3 of 8 All in Task 4) created risk of incomplete lists |
| Veterans will recognize list can be printed/shared | Partially | Print feature not discoverable for 4 of 8 participants in Task 4 |

---

## Recommendations by priority

### Consider addressing before V2 implementation

| Issue | Recommendation | Finding |
|---|---|---|
| Cross-links not prominent enough (missed by 3 participants in Task 1) | Increase visual prominence; consider button-style treatment | Insight 1 |
| Users often start on a page that does not have what they need (7 of 9 in Task 1) | Add contextual guidance when a page may not have what users expect; improve link labels | Insight 1 |
| "Update list" button is easy to miss (7 of 8 missed at least once; P7 excluded) | Auto-apply filters or make the button more prominent | Insight 2 |
...
| Print feature hard to find (4 of 8 had difficulty) | Move higher on page; relabel "Submit" to "Print" | 4 |
