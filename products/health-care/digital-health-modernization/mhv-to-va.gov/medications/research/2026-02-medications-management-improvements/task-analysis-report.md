# Task analysis: Medications management improvements usability study, February 2026

**UX Team:** Anneka Van Garza, Athena Bozak, Cara Frissel, Florence McCafftery

---

## Table of contents

- [Warm-up summary](#warm-up-summary)
- [Task 1: Find the refill status of Lipitor](#task-1-find-the-refill-status-of-lipitor)
- [Task 2: Find an old medication (rash cream)](#task-2-find-an-old-medication-rash-cream)
- [Task 3: Refill Metformin](#task-3-refill-metformin)
- [Task 4: Print current medications list](#task-4-print-current-medications-list)
- [Task 5: Refill all eligible medications at once](#task-5-refill-all-eligible-medications-at-once)
- [Wrap-up: Overall experience and sentiment](#wrap-up-overall-experience-and-sentiment)
- [Wrap-up: What users said worked well](#wrap-up-what-users-said-worked-well)
- [Wrap-up: Difficulties and what users would change](#wrap-up-difficulties-and-what-users-would-change)

---

## Warm-up summary

All 9 participants have been getting medications through the VA for 2 to 15 years, with most at 5 years or more (7 of 9). All manage regular, ongoing medications and refill on a predictable cycle, typically every 1 to 3 months.

Participants are split on how they refill: 5 primarily use VA.gov on a computer, 2 prefer the VA Health and Benefits mobile app, and 2 default to calling the pharmacy or sending secure messages. Several use more than one method.
...
- P7: "I would just go to the refill list."
- P7: "That's what I don't like. When there's no refills left, it takes it out of your list."
- P8: "Maybe I have it wrong, but refill medication basically tells me the same thing, that if it's a refill medication, then I go into it. And it'll show me what the, what refills are available or not."
- P8: "Go to your progress medications. Now I'm confused, because I'm not sure what that one means."
- P7 (on the "Go to in-progress medications" link): "I don't know what that is... I'm guessing that means you've placed the order."
- P7 (after moderator clicked the link): "Oh, well, that's nice. Because when I've called, sometimes I'm not sure, did I... I've asked the pharmacist, you know, I don't know, did I place this order, you know? So that's good, so I can check it on my own."

### Theme 2: The "Too early to refill, no action needed" grey card is understood but lacks visual prominence (9 of 9 understood; 3 of 9 had difficulty locating it)
...
**Participants:** P1, P4, P8, P12, P13, P15, P16

- P8: "Immediately, the first thing I thought of when I saw in-progress medications is, We're working on it."
- P8 (Request submitted): "Medication may not be here yet, but I know they're working on it."
- P12: "This lets me know everything I need to know at the present time."
- P15 (Submitted): "Well... it tells me which ones I've already requested, and it has been submitted."
- P15 (Fill in progress): "And then it tells me if the fill's in progress, so it tells me what's on the way."
- P15 (Shipped): "Tells me which ones, if any, have been already, shipped."
- P16 (Medication shipped): "This one's already been shipped. And if it's within a few days of that, then I can go in there and get my tracking info."
- P7: "Well, it tells me that I've, I've, you know, I should be expecting something. You know, to be on the lookout for my medications. You know, and that I've actually put them in, so I could keep track of what's out there."
- P15: "Gives me everything I need to know about in-progress medications."

---

## Task 2: Find an old medication (rash cream)

### Theme 1: Veterans struggle to locate the medication history page and often need multiple attempts to reach it (6 of 9)

Most participants did not have a clear or direct path to the Medication History page. Several started on the Medications page (refillable meds only) or the In-Progress Medications page and had to find cross-links like "Review and print list of medications" or navigate back to the MHV landing page. Some participants did not notice the cross-links at all without moderator prompting, and others considered navigating to "Records," "Messages," or "Appointments" as alternate strategies.

**Participants:** P4, P7, P8, P12, P13, P16

- P8: "I don't know why I wanted to go to records, but it's not as clear with medications. I'm not sure what it's going to tell me. In other words, it doesn't stand out for me. It doesn't sound like medications you have gotten in the past, or something like that."
...
- P8: "Inactive medications, stuff I don't take anymore."
- P16: "My first gut was to do inactive, because I knew that it was only a one-time thing, so it probably would have been inactive."
- P16 (on choosing "All" instead): "Just didn't know what it was and I didn't want to miss it."
- P13: "I'd be looking for all medications. Like a historical medication list."
- P8 (on expecting auto-update): Says he thinks the list should "popup/change" when he chooses "All meds" without clicking the button.

### Theme 3: After finding the old medication, Veterans know they need to contact their doctor to get it again (5 of 9)

Once participants located the rash cream and confirmed it was inactive, most understood they could not take action on it directly through the site and would need to contact their doctor through messaging or at an appointment.

**Participants:** P4, P5, P8, P12, P16

- P13: "So, now I know the name. What I would do is I would write it down in my phone and email it to myself so that I had the name and whatever dosage, Last filled date, so that if, you know, that helped the doctor look up because if it worked once well, I don't want to end up getting something different."
- P16: "Probably would just print this list and bring it to the doctor and would highlight the cream or circle it in pen. Actually would probably take his phone out and take a picture, or if was on the app would just take a screenshot and would bring that to his appt."

---

## Task 3: Refill Metformin

### Theme 1: Most Veterans can successfully locate and request a refill for Metformin, though starting points vary (7 of 8; P7 excluded due to technical issues)
...
- P16: "I'm confident it went through, and until it drops down here on the shipped label, I'm mildly confident it's... going through the steps, but I'm pretty sure there's a lot of people in the COG that have to get it from that submitted to the actual shipped location, so... but yes, I have full confidence that it's been submitted, it says it's submitted right here, here's the date, it's confirmed, it's under the request submitted list."
- P13: "Like I said, I want to make sure I know what's coming, when it's about to be filled. I try to stay on top of my mail."
- P13: "It's right there in front of me, request submitted."
- P1: Expects that clicking the link would show him a timeline of when he submitted the request, when it was approved, and shipping status. After clicking, states, "This is exactly what I would be hoping to see."
- P5: Feels "fairly confident 80-90%" that the refill request was submitted successfully, but says he does not want to be 100% confident in case the request gets "dropped."

### Theme 3: The "Update list" button continues to cause friction when Veterans start from the Medication History page (2 of 8)

Consistent with Task 2 findings, participants who began the refill task from the Medication History page encountered the same issue with the radio button filter not applying without clicking "Update list." In one case (P4), the filter failure masked a conceptual misunderstanding: she selected "Renewal needed before refill" but because the list never updated, Metformin remained visible under the default Active view, giving the false impression that her filter selection was correct.

**Participants:** P1, P4

- P1: "I keep forgetting that update list."
- P4 (on what "Renewal needed" means): "That means that it's too early for them to refill it. And, it's probably more than, like, the 10 days out that they normally say that I would have. So, if I need it earlier than that, I'm quite sure they'll ask me why, but then I'll be able to ask them that when they have... because they send it to them to look at it, I'm quite sure."

---

## Task 4: Print current medications list

### Theme 1: Veterans are split on whether "Active" or "All" medications represents their "current medications" list (7 of 8; P7 excluded due to technical issues)
...
- P16: "I'm not gonna want active. Personally, I'm gonna want all, because I'm gonna want them to know those ones that were down here,.. they may have dropped."
...
- P16: "Yeah, for me, relatively easy. I got the point in what I needed to do. Prescription refilling. It's pretty much, if you're allowed, you're allowed, and if you're not, then you're gonna get a pop-up telling you why not."

### Theme 2: Veterans use the green success alert and the in-progress medications page to verify bulk refill submissions (4 of 6)
...
- P16: "And then to be thorough, want to go to in progress medications to make sure they showed up there."

---

## Wrap-up: Overall experience and sentiment

### Theme 1: Veterans find the overall medications experience intuitive and easy to use (8 of 8; P7 excluded due to technical issues)

All participants who completed the session described the experience positively, using words like "easy," "intuitive," and "pleasant." Several noted that the design felt familiar and similar to what they currently use, which made it approachable. Participants who manage their medications regularly found the flow aligned well with their existing habits.

**Participants:** P1, P4, P5, P8, P12, P13, P15, P16
...
- P4: "I think once you understand how it works, it's very easy to use."
- P5: "I thought it was relatively... Easy, if you will Because I... Well... I knew what was being asked of me. It was clear as to what was wanted."
- P13: "This is more or less what I do every month when I'm looking at what meds I need, what meds I have refills on. It's active medication management. It's, you know, I have to keep on it, and keep doing it on a regular basis, and it has gotten progressively easier."
...
- P8: "And I think that the VA, when they start working on a program like this, they also need to think of the elderly veterans, not the younger veterans, but the elderly as well. I haven't had a whole lot of problems with this one, but as you can see, I still have problems with it. If they can even simplify it, and I mentioned that at the very at the beginning, if they can even simplify this, I would be so happy."
- P8: "But overall, I still think it would be a bit difficult for a veteran my age."
- P8: "Yeah, I'm really happy with what you did, and as a matter of fact, at the very end, when I made the comment about the user and the techies and all that, and it just hit me, you know, that's exactly what you guys are doing for us, and we'd need more of this."
- P12: "It wasn't... it wasn't difficult at all. As a matter of fact, it was a learning experience for me. Some of the things you went over, or tried to make me look for, I've never looked for before."
- P4: "I think once you understand how it works, it's very easy to use."
...
- P4: "I like that I can actually print my medications out if I need to take them."
- P5: "I think it's a good setup, kind of like simple."
- P15: "It seems to have everything that I need."
