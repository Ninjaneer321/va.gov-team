...
title: "Research Plan for Digital Health Modernization Team, MHV Discovery Research, December 2020"
date: 2020-12-07
...
research_goals:
  - goal_1: "Understand how the current MHV patient portal supports user needs, and where there are opportunities to bridge gaps or improve on existing functionality"
  - goal_2: "Learn what health related content and tools outside of the MHV patient portal do users find valuable and need integrated into their experience to support their end-to-end workflows"
  - goal_3: "Understand what attitudes Veterans hold toward the MHV brand and which aspects of the MHV brand generate trust"
  - goal_4: "Discover who Veterans need to share their health information with, and how they would like to be able to manage sharing information and granting permissions"

research_questions:
  - "How does the current MHV patient portal support user needs?"
  - "What health related content and tools outside of the MHV patient portal do users find valuable?"
  - "What attitudes do Veterans hold toward the MHV brand?"
  - "Which aspects of the MHV brand generate trust?"
  - "Who do Veterans need to share their health information with?"
  - "How would Veterans like to be able to manage sharing information and granting permissions?"

hypotheses:
  - "The MHV patient portal provides value by supporting core transactional functionality for health tasks, but that personal health record functionality, health content, and MHV communications are under-utilized."
...
expected_outcomes: "Rich, qualitative data about Veterans' health experience that will inform how MHV might be integrated into VA.gov to provide a streamlined, consistent end-to-end experience."
...
recruitment:
  ...
  primary_criteria:
    ...
    - "At least 4 participants who use health care only, or health care and disability compensation"
    ...
    - "At least 4 participants who access VA benefits for themselves and their dependents"
    - "At least 4 participants who are caregivers to Veterans and/or their dependents"
  ...
  secondary_criteria:
    ...
    - "Geographic diversity: 7 east coast, 2 mid-west, 3 west coast"
...
octo_priorities:
  - objective: "Veterans can manage their health services online"
    key_results: 
      - "Integrate MHV into VA.gov for streamlined experience"
