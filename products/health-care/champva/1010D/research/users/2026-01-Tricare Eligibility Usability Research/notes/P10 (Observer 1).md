...
#### Introduction
- Partner served in Air Force, TRICARE was their healthcare while parner was in serving, now they still use it and pay for it
...
- Looks like an intro to CHAMPVA, an application for medical care, essentially
- The page asks if you've heard/know of CHAMPVA, which I've never
- Eligibility... pretty step by step, I like that
...
- This page could be hard for someone who's deaf
- "It might say yes you are eligible or not and I hope it just says yes."
- Easy, scores it an 8/10, changes to 5/5 ;)
  - I personally hate visiting this website because theres so many pages, articles, etc
  - But I like this page because it's all laid out step by step


#### Second Task: [ELIGIBILITY PATTERN] 

- Page 1
  - "Not sure what that last sentence is about" they kinda take it personally!
- Page 2
  - Makes sense!
- Page 3
  - If someone's in a rush people can miss that they they're filling out info for the veteran, not themselves as a spouse.
 - Theres a lot of information in this alert. So you can be eligible for TRICARE and not CHAMPVA, okay. Hard to parse.
 - It did what I thought it was: checked my social security number, CHAMPVA verified what I am and am not eligible for. "May not be eligible?" well am I or am I not?
   - In this placement, this alert is confusing to me. Maybe it should have been before I started the form/filling out info.
   - This could be very confusing especially to an old person! They get to this point and the wording has them wondering "should I go on? Should I not?"
   - "I would hit continue just to see what happens next!"
...
- Page 7
  ...
  - I'M GONNA CONTINUE! Cuz why not ;)
  - Ease of use score: 1/5
    - Confusing!
- Back to prototype start page
...
- Page 3
  - Pretty standard
- Page 4
  - He has not died, we'll continue
- Page 5
  - Yes
- Page 6
  - No, okay.
...
- Page 7 
  - Oh god dang.
  - Now I get green checks.
  - Now I know that if you don't have TRICARE then I'm gonna get a green check.
  - So I'm assuming that I read the prev prototype wrong, you can't have both.
  - Nothing is making me second guess anything, so we're all green good to go!
...
- Alert C
  ...
  - We're human, fat fingers, we make errors.
...
- Card Style B
  ...
  - Seems like extra sentence helps, but participant is confused, structure of prototype is confusing, isn't sure of what isn't being asked of them. Kinda just giving up, which is fair. Lots of content.
  - "I feel like I'm in an escape room and I'm not figuring out the way out here."
  - Conditioned on colors. Red means not to proceed with the application
  - Preference between card styles? "I like the second set because of new two lines" which make the situation plain and simple.

#### Post-Task Interview
- "That was crazy."
- I think anything military-related should be easily accessible and 'right there.'
- Sometimes I've applied for things through the VA or anything military and you always really have to deep dive for clarity.
- You should have a solid understanding for what you're applying for
