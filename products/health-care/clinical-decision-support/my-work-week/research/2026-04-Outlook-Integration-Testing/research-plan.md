...
# Background Context
background:
  problem_statement: "VA of existing patient-search related user findings from prior CDS Console studies to inform the design and implementation of patient lookup and reverse patient context features."
