---
title: "Unmoderated Appointment Information Prioritization (Pre-check-in)"
...
research_goals:
  - "Identify what appointment data is most important within certain portions of the pre-check-in experience"
methodology:
  - "Unmoderated study"
  - "Online survey"
devices_used:
...
key_findings:
  ...
  - "A lot of the top ranked appointment information is similar across the pre-check-in and check-in scenarios: Appointment time and timezone, Canceled status, Date of the appointment, Day of appointment, Location, Type of care, Visit type"
recommendations:
...
kpi_alignment: []
outcomes:
  user: "Veterans can review the most important information when confirming their appointment 3 days before"
  business: "Identify what appointment data is most important within pre-check-in experience"
opportunity_areas:
