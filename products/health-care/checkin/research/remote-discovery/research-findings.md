...
researchers:
  - "Kristen McConnell"
research_goals:
  - "Understand Veterans' feelings, pain points, and value-gained by using the current ecosystem of check-in methods for medical appointments"
  - "Understand the current kiosk method, because it is being replaced by a digital check-in solution on mobile and/or va.gov"
  - "Understand how Veterans feel when interacting with each check-in method (focus heavily on kiosk workflows)"
...
key_findings:
  ...
  - "Veterans unanimously wished other health systems had check-in processes like the VA"
