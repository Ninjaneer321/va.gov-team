---
title: "Modernized Check-In Experience: Corpus Christi In-Person Visit Veteran Interviews Research Findings"
...
research_goals:
  ...
  - "Observe the utilization of the Spanish version of check-in, evaluate accuracy and quality of the translations"
...
recommendations:
  ...
  - "Reimagine the text portion of the workflow in one or more of the following ways: Notify Veterans better that there are more steps. Don't make Veterans start the workflow by creating a text or scanning the QR code. Instead, push a check-in notification to Veterans when they can check-in (30 minutes prior to their appt). Spend more time educating Veterans about the process."
...
opportunity_areas:
  - "Improving the texting and QR code scanning workflow"
  - "Adding insurance editing and review capabilities to PCI"
  - "Integrating travel reimbursement into check-in"
  - "Expanding PCI to additional appointment types (labs, walk-ins)"
  - "Clarifying the distinction between pre-check-in and day-of check-in"
  - "Reducing scenarios that direct Veterans to 'see staff'"
further_research_needed:
  - "Remote research study with bilingual Veterans to understand language needs and Spanish translation quality"
underserved_groups_missing:
  - "Spanish-speaking Veterans (insufficient participation to evaluate Spanish translation)"
secondary_research: []
