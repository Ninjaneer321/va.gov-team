...
recommendations:
  ...
  - "Talk to more travel assistants at Bay Pines and Corpus Christi to better understand what information in claims they're reviewing, why it's important and how they're making decisions as a means to optimize a travel reimbursement experience within PCI."
  - "Explore reintroducing a VA-owned check-in device in clinics – once kiosks are removed and remaining functionality has been migrated into PCI or elsewhere – to better serve the needs of Veterans with vision challenges and those who prefer a larger screen."
  ...
  - "Evaluate and prioritize all feedback mentioned by MSAs and one clinician about staff-facing applications that has been previously reported. E.g., adding last four, too much of a delay, update Veteran's cell phone number, etc."
...
further_research_needed:
  - "Talk to more travel assistants at Bay Pines and Corpus Christi to better understand what information in claims they're reviewing"
