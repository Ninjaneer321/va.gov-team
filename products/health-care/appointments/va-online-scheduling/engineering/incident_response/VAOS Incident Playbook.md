...
(**Deprecated** - Replaced by [Appointments Incident Response Playbook 2.0.md](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/health-care/appointments/va-online-scheduling/engineering/incident_response/Appointments%20Incident%20Response%20Playbook%202.0.md))
...
3. Request Rate or Errors exceededing a predefined % of total request rate.
...
As a developer on the MHV Appointments team we are each responsible for our contributions. This means that shortly after a production deploy we monitor Datadog closely to see if there is an issues associated with recent coding changes. This should be standard operating procedure when you have merged code that is deployed on a given day.
...
1. Identify 3 or more issues from Datadog or other logs and document the following:
