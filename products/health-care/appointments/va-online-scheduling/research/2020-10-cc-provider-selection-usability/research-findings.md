---
title: "CC Provider Selection Usability Study Research Findings"
...
research_goals:
  ...
  - "Understand Veterans' expectations around appointment availability and provider selection"
  - "Test Veterans' trust in the appointment scheduling process"
  - "Identify what information Veterans need to identify and prepare for their appointments"
methodology:
...
key_findings:
  ...
  - "Some participants expected that the date they entered into the calendar would be tied to the provider selection"
  - "Participants liked knowing a provider's distance, but some wanted to see the provider list in alphabetical order so they could find someone who they already knew"
  - "Most preferred seeing providers in the context of the list over the map"
  ...
  - "All participants described problems with scheduling appointments in the past that caused them frustration with appointment scheduling"
  - "Most participants expected that scheduling online should be faster than scheduling over the phone"
  - "Some participants did not understand they were requesting an appointment until close to the end of the prototype"
  - "Date and location (either physical or online) was most important to participants for identifying appointments"
  - "Type of care is necessary for differentiating appointments from one another"
recommendations:
  ...
  - "Consider moving the calendar to later in the request process, or removing it entirely for community care appointment requests"
  - "Consider adding gender, job title, and some indication that the provider is VA approved to the provider list"
  ...
  - "If possible, provide a rough estimate of the time it is expected to take for common scenarios"
...
opportunity_areas:
  ...
  - "Veterans want provider reviews and reputation information"
  - "Veterans need better communication about appointment status and changes"
  - "Veterans need clarity on whether they are scheduling or requesting an appointment"
further_research_needed:
  - "Validate that schedulers would be able to speed up the process of finding care if they had three provider options"
  - "A round of follow up questions is needed to validate if schedulers use calendar data for community care requests"
underserved_groups_missing: []
secondary_research:
  - "Facility team's research with Community Care scheduling staff"
