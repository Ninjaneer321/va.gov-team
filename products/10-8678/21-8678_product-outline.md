# 10-8678 Form Digitization

---

## Overview
The PingWind team will create a digital version of VA 10-8678 (Application for Annual Clothing Allowance), which will enable users to apply online for clothing allowance benefits. This online form will make it easier to request these benefits without having to mail in a paper form.

## Problem Statement
As part of the Benefits Intake Optimization Project, the VA has a goal to digitize new forms. Form VA 10-8678 is on the list of additional forms to be digitized. This is a critical form for Veterans to apply for clothing allowance benefits. The current process is entirely paper based, and dependent on physical mail. Currently, there is no option to submit this form electronically.
...
By digitizing VA Form 10-8678, users will gain new capabilities:
