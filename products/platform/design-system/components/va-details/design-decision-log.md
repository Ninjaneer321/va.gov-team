# va-details Design Decisions (initially va-additional-info slim)
...
### Decision
We will create a new details component. 

### Consequences
It could take time for teams to adopt the new component. It’s visually and semantically different from additional info  but not in purpose or design. We do not see a problem with having both styles out there for awhile. 
