...
1. **Is the issue unique to the form, or is it affecting VA.gov as well?**<br/>
  Check the [#oncall](https://dsva.slack.com/archives/C30LCU8S3) and [#vfs-platform-support](https://dsva.slack.com/archives/CBU0KDSB1) channels. If VSP staff are aware of and addressing the incident you can stand by and make yourself available for escalation of any form-specific questions. You should keep tabs on the overall response and make sure it is addressed in a reasonable time frame.
...
At this point you should also raise the incident to our team in the DSVA Slack [#benefits-decision-reviews](https://dsva.slack.com/archives/C5AGLBNRK) channel.

## Incident Classification
1. First, determine as well as you can whether this issue is unique to the supplemental claim form, or is likely affecting VA.gov as well. In the latter case, check the [#oncall](https://dsva.slack.com/archives/C30LCU8S3) and [#vfs-platform-support](https://dsva.slack.com/archives/CBU0KDSB1) channels in DSVA Slack to ensure you are not duplicating effort (or working at cross purposes) with anybody else.
...
In all phases of incident response, clear communication is key. Every incident of any meaningful severity is likely to require coordination with other teams to resolve. If you own the incident, ensure that other responders understand the nature and severity of the incident, what steps you/your team is taking to respond, and what steps you are asking them to take to respond.
