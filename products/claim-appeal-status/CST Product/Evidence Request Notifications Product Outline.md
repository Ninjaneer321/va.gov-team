...
- We are not including the alternative link to copy and paste, just including the universal link to keep the email simple and reduce confusion. If we do decide to include the copy and paste option, here are exploratory designs.
...
- We can’t have “Action needed” in the subject line because the guidance says: If it’s a post-submission failure notification (part of the zero silent failures initiative), start the subject line with “Action needed”. guide
