...
|8/14/2025| Information on the Veteran Status Card can change over time. | Michelle got input from a SME about VSC changes. The information most likely to change on the Veteran Status Card includes name and disability rating. Information that can also change but changes less often is the last period of service information (i.e., someone rejoins if they're in the reserves/national guard).|
