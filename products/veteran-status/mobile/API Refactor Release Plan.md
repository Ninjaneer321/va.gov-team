...
* How will you make the product available in production while limiting the number of users who can find/access it:   
  ...
  * We will plan to check the metrics around 12:30pm ET and then determine to increase at that time, so that the MFS and CVE team can immediately identify any issues.   
