---
title: "Veteran Status Use Case Discovery Research Findings"
...
research_goals:
  ...
  - "Where would participants expect to find these tools?"
methodology:
...
key_findings:
  ...
  - "Participants have a wide range of Veteran IDs on hand that get the job done"
  ...
  - "Veterans link learning about a discount with access and want to learn about discounts in a way that makes it easier for them to access the discount."
  - "Participants were excited by the idea of an easy-to-access tool on a mobile device (e.g. mobile wallet)."
  - "Blind veterans in particular value in a mobile card"
  - "When it comes to finding tools, participants gravitated to private sector or VA-agnostic destinations."
recommendations:
  - "For veterans, being aware of available discounts is a more pressing pain point than having the tools needed to access them. Consider focusing on a solution that makes discounts easier to find, via [note: recommendation text appears truncated in source document]"
  - "Focus on accessibility and how accessible digital cards can drastically improve the lived experiences of blind veterans. Consider a solution such as a card for a mobile wallet or other solution tha[note: recommendation text appears truncated in source document]"
kpi_alignment: []
outcomes:
