...
# Conversation Guide - STEM Automated Decision - Eligible Applicants
...
Thanks for joining us today! My name is [NAME] and I also have some colleagues on the line observing and taking notes. The purpose of today's session is for us to observe you submitting an application for the VA's STEM Scholarship using the 22-10203 form on VA.gov. 
...
#### Things to watch for:
1. Watch as the applicant completes the eligibility questions to confirm they will NOT receive an Automated Denial (Step 3 of 6)
