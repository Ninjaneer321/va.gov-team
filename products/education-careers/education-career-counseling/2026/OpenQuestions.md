...
1. **Signature & Certification**
   ...
   - It’s unclear:
     ...
     - Who is expected to sign in dependent scenarios
     - Whether one or multiple signatures are required

2. **Sponsor Education Status**
   - The paper form includes education status questions for both the applicant and the sponsor.
   - In the digital flow, it’s unclear:
     - Whether sponsor education status is required for eligibility or processing
     - Or whether it exists solely for parity with the paper form
...
3. **Active Duty Status & Military History Requirements**
   ...
   - The paper form captures **full military history**, but the current digital experience does not.
   - Open questions include:
     - Whether full service history is required or only the most recent period
...
4. **Use of Intro / Grounding Pages**
   ...
   - Alignment is needed to ensure the experience feels intentional and consistent.
