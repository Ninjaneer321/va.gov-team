...
- Goal
  - Get a more nuanced understanding of the current application experience process from veterans
- Key research questions
  - What are the most confusing or difficult portions of the current process that we can focus on?
  - How significant is time spent in data collection in filling out this application?
...
- Did you complete this application in one sitting or did you have to come back to it? If so, where in the process was the delay?
