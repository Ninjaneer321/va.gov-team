...
# Conversation Guide for GIBCT Profile Page Testing
...
Thanks for joining us today! My name is Jen and I also have some colleagues on the line observing and taking notes. Today we're going to talk about discovering information about schools on the GI Bill Comparison Tool. 
...
- Does the user notice the jumplinks?
- Does the user click the jumplinks?
- Does the user notice the Compare functionality?
- Does the user notice the religious affiliation in the heading?
