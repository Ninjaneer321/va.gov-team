---
title: "Streamlined Waiver Accessibility Study Research Findings"
product: "Financial Status Report (FSR) - Streamlined Waiver Path"
...
researchers:
  ...
  - "Sara Smith"
research_goals:
  - "Understand accessibility of the non visual user experience of the eFSR (Streamlined Waiver) forms and what improvements can be made (efficiency, auditory scannability, proficiency, flexibility)"
  - "Understand how this form compares in contrast to mental models Veterans that use screen readers have with other forms"
  - "Understand Veterans level of satisfaction with the eFSR (Streamlined Waiver) form"
methodology:
...
key_findings:
  - |
    The ease of use of the financial status report form (streamlined waiver path) seemed to differ across participants based on the type of screen reader used and their level of proficiency with it, which made each experience unique.
  - |
    The experience of navigating through the form if the participant was fully reliant on the screen reader (if blind) or if they were partially reliant on the screen reader (if low vision) presented different challenges.
  - |
    We found that users of screen readers were extraordinarily patient.
  - |
    The login process was time-consuming and led to many participants running out of time to interact with the form.
  - |
    Two participants were confused by the cancel button on the Work History List Loop.
  - |
    VoiceOver is not reading all information on the form pages, including the Transition page.
  - |
    The 2 participants that completed the form from start to finish felt that the form didn't flow as much as they would have wished, and wished for the convenience of hearing the entire form read to them.
recommendations:
  - |
...
opportunity_areas:
  - "Creating an unauthenticated form for future usability studies to avoid login barriers"
  - "Building a read-aloud feature directly into forms so Veterans do not need to rely entirely on external screen readers"
  - "Improving Focus attribute handling so VoiceOver reads all page content including Transition pages and Additional Information components"
...
underserved_groups_missing:
  - "Asian Veterans"
  - "Expat (living abroad)"
  - "Cognitive disabilities (not asked)"
  - "Immigrant origin (not asked)"
  - "Other than honorable (not asked)"
  - "LGBTQ+ (not asked)"
secondary_research:
  - "Streamlined Waiver (FSR) Research 08/2023"
  - "Enhanced Financial Status Report Research 06/2023"
