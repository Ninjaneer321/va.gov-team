...
researchers:
  ...
  - "Alex Taylor"
research_goals:
  - "Determine if the current concept of refilling a prescription matches Veteran's expectations and understanding"
  - "Identify major usability or content issues with the current concept of viewing prescription history and tracking prescriptions"
methodology:
...
key_findings:
  ...
  - "Participants liked being able to filter and look for more detailed information as needed"
  ...
  - "Participants didn't understand what the non-refillable tab was, and why it contained a separate list of prescriptions"
...
recommendations:
  ...
  - "Change the concept of a non-refillable tab and put these prescriptions in the list of prescriptions deemed in-progress"
  ...
  - "Consider incorporating a history view for prescriptions to see how medications have changed over time"
kpi_alignment:
...
outcomes:
  user: "Veterans can easily request prescription refills through the mobile app with clear status tracking"
  business: "Increased usage of digital self-service tools; decreased call center volume, wait time, and time to resolution"
opportunity_areas:
...
* Half of all participants said they don’t typically look at tracking information 
...
* Design and build the “Renewal requests experience”; keep a button leading to this function in the homepage
