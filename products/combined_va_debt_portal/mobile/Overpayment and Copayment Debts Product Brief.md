...
|4/1/2026| Transaction history will be included in Overpay MVP.|Kim confirmed that the FM team is surfacing the data for transaction history so users will be able to see this on mobile app. [Link](https://dsva.slack.com/archives/C07S7TJRK0B/p1775063061868149?thread_ts=1774969089.122899&cid=C07S7TJRK0B) to message. |
