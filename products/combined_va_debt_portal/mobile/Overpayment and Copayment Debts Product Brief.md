...
|2/4/2026| Content for mobile and web alerts will align, but display of telephone numbers does not need to align.|Denise agreed to this during our FM/MFS sync since the FM team has implemented a help icon that will have the phone numbers. MFS will keep the phone numbers to align with other mobile alerts.|
