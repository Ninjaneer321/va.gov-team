...
**Last Updated: 4/2/2026 -- Updated for Profile 2.0 information architecture and health care settings**

## Table of Contents

- [Section Outline: The VA.gov Profile](#section-outline-the-vagov-profile)
  ...
  - [Projects](#projects)
    ...
    - [Completed projects \& enhancements](#completed-projects--enhancements)
      - [General](#general)
      - [Personal information](#personal-information)
      - [Contact information](#contact-information)
      - [Military information](#military-information)
      - [Direct desposit information](#direct-desposit-information)
...
|---------------|-------------|--------------|--------------------------|:-:|
|[Nametag](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/identity-personalization/profile/nametag) | Shows  the full name for all LOA3 users.| Full Name - MPI; Military info - VA Profile | [#vsp-identity](https://dsva.slack.com/channels/vsp-identity) [#va-profile](https://dsva.slack.com/channels/va-profile)| AE Profile |
...
|[Health care settings](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/identity-personalization/profile/health-care-settings)| Parent section for personal health care contacts, messages signature, and scheduling preferences | VA Profile and MHV integrations | [#va-profile](https://dsva.slack.com/channels/va-profile) and dependent partner teams | AE Profile |
...
|[Service history information](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/identity-personalization/profile/military-information)| Shows military branch(es) of service and service period(s)| VA Profile | [#va-profile](https://dsva.slack.com/channels/va-profile) or Mike Richard (Michael.Richard2@va.gov) |  AE Profile |
|Dependents and contacts| Parent section for benefits dependents and accredited representative or VSO | mixed | varies by child page | AE Profile |
|Letters and documents| Parent section for letters/documents child pages including Veteran Status Card | mixed | varies by child page | AE Profile |
|[Veteran Status Card](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/veteran-status/README.md)| The veteran status card now lives under Letters and documents in Profile 2.0|      | [#veteran-status](https://dsva.slack.com/archives/C061RNJQ6SE/p1711980999826959) |  Veteran Status Card Team |
|[Financial information / Direct deposit information](https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/identity-personalization/direct-deposit)| Allows comp & pen payment recipients and Ch33 recipients to update their direct deposit information| Lighthouse |  Lighthouse ([#lighthouse-delivery-platform-support](https://dsva.slack.com/channels/lighthouse-delivery-platform-support)) or Nichole Harris (harris_nichole@bah.com) |  AE Profile |
...
The current VA.gov Profile experience reflects the Profile 2.0 implementation work that was completed incrementally between October 2025 and March 2026 with a phased roll out from 3/9/26-3/13/26.

Key characteristics of the current implementation:

- `/profile` is a hub-first landing page
- the navigation uses parent and child pages instead of only flat leaf pages
- breadcrumbs now utilize the VADS sidenav component and include nested links and VADS standard breadcrumbs
- legacy Profile URLs redirect to new Profile 2.0 routes to prevent inbound links leading to a 404
- Health care settings is its own top-level section
- feature availability can vary based on feature toggles and user eligibility
...
- Direct deposit under Financial information
- Personal health care contacts, messages signature, and scheduling preferences under Health care settings
- Accredited representative or VSO under Dependents and contacts
- Veteran Status Card under Letters and documents
- Connected apps and sign-in information under Account security
...
- [Scheduling Preferences (sensitive)](https://github.com/department-of-veterans-affairs/va.gov-team-sensitive/blob/master/products/identity-personalization/profile/health_care_settings/scheduling_preferences/backend_documentation.md)
...
- [Scheduling Preferences (sensitive)](https://github.com/department-of-veterans-affairs/va.gov-team-sensitive/blob/master/products/identity-personalization/profile/health_care_settings/scheduling_preferences/frontend_documentation.md)
