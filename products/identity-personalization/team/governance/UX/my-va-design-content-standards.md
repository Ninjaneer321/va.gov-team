...
5. (Required) Card body text to include  
   4. Submitted on date  
   5. Submission failed on date  
6. (Required) Alert  
   1. (IF form has PDF download option) Instructs user to upload PDF to Quicksubmit
   2. Instructs user to call the help desk
   3. (Editable) Phone number, dates, and times only
