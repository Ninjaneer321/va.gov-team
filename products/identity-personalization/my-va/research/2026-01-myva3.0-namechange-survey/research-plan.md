...
[Implementation is being informed by secondary research](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/products/identity-personalization/my-va/research/2025-03-secondaryresearch/research-findings.md)
...
2\. Do the recommendation to rename My VA to My VA Dashboard, based on prior research and user feedback, match Veterans mental models?
...
Survey: Evaluating updates to an existing experience based on past research recommendations.
...
* Link to email with instructions (Add in link)  
* Link to OptimalSort session (Add in link)
...
* 252 / Frequent VA.gov users (Monthly, Daily or Weekly)  
* 252 / Non frequent VA.gov users (Every few months or Never, but am open to using VA.gov)
...
* Reviewed by \[Chante, OCTO Product Owner\] on \[TBR\]  
* Reviewed by OCTO Research-Ops Lead on \[TBR\]
