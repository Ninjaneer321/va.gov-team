# Research Plan: Discovery Research on Claimant Lifecycle for Accredited RepresentativesThe Accredited Representative Crew
...
The Accredited Representative Portal (ARP) is a VA product designed for representatives, specifically Veteran Service Organizations (VSOs), Attorneys, and Claims Agents, who assist Veterans and their dependents with submitting claims and appeals as well as establishing power of attorney.

ARP is accessible at[ VA.gov/representative](http://va.gov/representative) and requires a[ Login.gov](http://login.gov) or[ ID.me](http://id.me) authentication. It is a modern digital solution designed to expedite the claim submission and establishment process. By reducing administrative tasks, ARP allows representatives to concentrate on delivering a high-quality experience for Veterans, supporting the shared goal between representatives and claimants.

As a team, we have gaps in our knowledge regarding accredited representatives’ experiences with the claimant lifecycle. The Accredited Representative Crew wants to learn more about how representatives manage their caseloads, any pain points and needs, as well as get a better understanding of their daily workflows.

[Product Brief](https://dvagov.sharepoint.com/:w:/r/sites/vaabdvro/_layouts/15/Doc.aspx?sourcedoc=%7B779564f1-688c-4ffc-9e10-df8992bdbd34%7D&action=edit&wdPid=2450396e)
...
5. What features, tools, data, notification/status and technology do representatives need to effectively manage their workflows?
6. How does having access or not to items like a PIV card, VBMS, and/or claims management software shape the claimant lifecycle experience for accredited representatives?


### **Methodology**

Discovery research interviews with accredited representatives over 60-minute remote Zoom/Teams video calls.
...
[Research Epic](https://github.com/department-of-veterans-affairs/va.gov-team/issues/121940#issuecomment-3547519559)


### **Recruitment**

This research will include interviewing 12 accredited representatives from the following categories:
...
* Draft, revise, and finalize research plan. Begin drafting conversation guide: 11/17-11/24
* Revise and finalize conversation guide. Draft recruitment messages and begin recruiting, and scheduling: 12/1-12/12
* Conduct interviews and scrub transcripts: 12/8-12/22 *(**with the potential of extending into beginning of January if holidays conflict with recruiting efforts)*
* Analysis, drafting of report, and feedback: 1/2-1/9
* Finalize report, research readout, and research wrap-up/archive: 1/12-1/16
...
Research guide writing and task development: Heather Roy

Participant recruiting: Heather Roy

Project point of contact: Heather Roy

Note-takers: Rotation among UX crew–Michael Tri, Jen Seipel, and Marisa Dominguez

Observers: Heather Roy will forward invites to appropriate team members.


### **Approvals**

Reviewed by OCTO Enablement Team Leaders: Shannon Ford, Jen Bertsch on 11/24/25

Reviewed by OCTO Research-Ops Lead Marisa Dominguez on Thursday 11/20/25
