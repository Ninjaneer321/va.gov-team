...
a. Based on interview data, the most important VBMS updates are as followed in order of importance: 1) VBMS access, 2) Claim Status Changes (e.g.; "Ready for Decision," "Pending Approval," "Rating Decision Complete," etc.) 3) C&P Exams (Requests, Vendor Assisgnments, and Outcomes) 4)EP Changes, 5) Tracked Items, 6) Suspense dates, 7) New Documents, and 8) Form submission receipt.
